...
description: An in-depth explanation for "coin exchange" problem.
---
...
![Diagram of recursion tree for the coin exchange problem.](./coin_change_recursion_tree.png)
...
![Diagram of recursion tree explaining memoization.](./coin_change_memoize.png)
...
![Written out explanation for how to think about the coin exchange problem in a bottom-up fashion.](./coin_change_bottomup.png)
...
![Screenshot turned to GIF of terminal indiciating the performance level of the three algorithms covered in this blog post.](./coin_change_performance.gif)
