...
description: Track record of an entire day well spent - on the cloud.
---

![AWS lambda and AWS S3 logo](./aws_lambda_s3.png)
...
![Screenshot of AWS lambda create function page](./create_lambda.png)
...
![Screenshot of terminal error related to Python's Pillow module](./pillow_screenshot.png)
...
![Image of Docker logo](./docker_logo.png)
