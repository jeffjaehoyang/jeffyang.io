      ...
      <div className="news">
        ...
        <div className="news-content-wrapper">
          ...
          <div className="news-post">
            ...
            <span className="news-content">
              Attending{' '}
              <a href="https://treehacks-2020.devpost.com/?ref_content=default&ref_feature=challenge&ref_medium=discover">
                <b>TreeHacks 2020</b>
              </a>{' '}
              @Stanford 🌴
            </span>
          ...
          <div className="news-post">
            ...
            <span className="news-content">
              Accepted an internship offer from{' '}
              <a href="https://www.esri.com/en-us/home">
                <b>Esri</b>
              </a>{' '}
              for summer 2020 🌎
