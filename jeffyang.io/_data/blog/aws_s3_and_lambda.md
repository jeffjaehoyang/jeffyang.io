---
template: BlogPost
path: /resize-images-stored-in-aws-s3-with-aws-lambda
...
![A screenshot of AWS lambda create function page.](/assets/create_lambda.png#fluid)
...
![A screenshot of the terminal showing import errors resulting from Python's Pillow module.](/assets/pillow_screenshot.png#fluid)
...
![Docker's logo.](/assets/docker.png#fluid)
