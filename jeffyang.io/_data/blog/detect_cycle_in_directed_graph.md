...
metaDescription: A blog post on how to solve the course schedule problem on LeetCode
...
![A diagram that represents an acyclic graph.](/assets/acyclic_graph.png#fluid)
...
![A diagram that represents a cyclic graph.](/assets/cyclic_graph.png#fluid)
