...
draft: false
summary: 'A blog post on how to solve the course schedule problem on LeetCode'
---

![Blog Post Thumbnail](/static/images/detect-cycle-in-directed-graph/course_schedule_cover.png)
...
![A diagram that represents an acyclic graph.](/static/images/detect-cycle-in-directed-graph/acyclic_graph.png)
...
![A diagram that represents a cyclic graph.](/static/images/detect-cycle-in-directed-graph/cyclic_graph.png)
