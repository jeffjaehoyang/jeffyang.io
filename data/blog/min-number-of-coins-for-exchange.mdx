...
draft: false
summary: 'A blog post on how to solve the coin exchange problem'
---

![Blog Post Thumbnail](/static/images/min-num-coins-for-exchange/min_num_coins_for_exchange_cover.png)
...
![Diagram that illustrates the recursion tree for the coin exchange problem](/static/images/min-num-coins-for-exchange/coin_change_recursion_tree.png)
...
![Diagram that illustrates the recursion tree explaining memoization for the coin exchange problem](/static/images/min-num-coins-for-exchange/coin_change_memoize.png)
...
![Diagram that illustrates the recursion tree for the coin exchange problem](/static/images/min-num-coins-for-exchange/coin_change_bottomup.png)
...
![Diagram that illustrates the recursion tree for the coin exchange problem](/static/images/min-num-coins-for-exchange/coin_change_performance.gif)
