...
draft: false
summary: 'Walk-through of how to solve the balanced binary tree problem on LeetCode'
---
...
![A diagram that represents a binary tree with a root node at the top.](/static/images/balanced-binary-tree/root.png)
...
![A diagram that illustrates a depth-first traversal of a binary tree.](/static/images/balanced-binary-tree/root2.png)
...
![A diagram that represents a skewed tree.](/static/images/balanced-binary-tree/root3.png)
