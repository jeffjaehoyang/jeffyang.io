...
client_id=404582dc657d46e1b083ccdd1ff8bd00
client_secret=51715f5c011144738af8504bcd0450ba
port=3000
...
response=$(curl -s https://accounts.spotify.com/api/token \
  ...
  -d "grant_type=authorization_code&code=$code&redirect_uri=http%3A%2F%2Flocalhost%3A$port")
